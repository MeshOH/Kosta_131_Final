...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="./css/flex_sitewide_css.css" media="all" rel="stylesheet" type="text/css" />
                ...
                <div class="fluid-container">
                    <div class="row">
                        ...
                        <div class="phone-col-2 tablet-col-2 desktop-col-2">
                            <a href="#"><img src="./image/matitda.png" width="200px" height="80px" padding="100px"></a>
                        </div>
                        ...
                        <div class="phone-col-5 tablet-col-5 desktop-col-5">
							...
							<c:choose>
							<c:when test="${vo==null}">
								 <li><a href="#" class="invite" data-toggle="modal"
								data-target="#registerModal">회원가입</a></li>
								 <li><a href="#" class="invite" data-toggle="modal"
		...
		<div class="modal fade" id="registerModal" role="dialog">
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="member.do" enctype="multipart/form-data">
							<input type="hidden" name="command" value="register">
							<div class="form-group">
								<label for="profileImgUrl" >프로필 사진</label> <input type="file"
									class="form-control" id="profileImgUrl" style="width: 300px;margin-left: -10px; border: none;" >
							</div>
							<div class="form-group">
